...
Instead of navigating through multiple screens in the Intune admin center, simply search for a device and perform the action you need.
...
- View device information
  ...
  - Model
  - Last Sync
- Launch Microsoft Remote Help sessions
- Send Sync commands
...
All Remote Help sessions are stored locally and can also be viewed directly from within the application.
